...
func TestDecode(t *testing.T) {
	for _, golden := range [...]goldenDecode{
		{verticalCodes[-1] + verticalCodes[0],
			"wwb"},
		{passCode + verticalCodes[-2] + passCode,
			"www.wbb"},
		{verticalCodes[-3] + passCode + verticalCodes[1] + verticalCodes[0],
			"bbb.wbb"},
		{verticalCodes[-2] + verticalCodes[-1] + passCode +
			verticalCodes[-1] + passCode,
			"wbw.bbb"},
		{horizontalCode + whiteCodes[2] + blackCodes[2] +
			verticalCodes[-1] + horizontalCode + blackCodes[2] + whiteCodes[1],
			"wwbb.wbbw"},
		{verticalCodes[-3] + verticalCodes[-1] + passCode + passCode +
			horizontalCode + whiteCodes[0] + blackCodes[1],
			"wbbw.wwwb"},
		{horizontalCode + whiteCodes[0] + blackCodes[3] + passCode +
			passCode + horizontalCode + whiteCodes[0] + blackCodes[1],
			"bbbw.wwwb"},

		// out of bounds:
		{verticalCodes[3] + verticalCodes[-1] + verticalCodes[2],
			"ww.wb"},
		{verticalCodes[-3] + verticalCodes[1] + verticalCodes[-2] + verticalCodes[3],
			"bb.bb"},
		{verticalCodes[-1] + verticalCodes[2] + verticalCodes[-2] + verticalCodes[2],
			"wb.bb"},
		{horizontalCode + whiteCodes[1] + blackCodes[2],
			"wb"},
		{horizontalCode + sharedMakeUpCodes[6] + whiteCodes[1] + blackCodes[1],
			"ww"},
	} {
